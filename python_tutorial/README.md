...
I chose to analyze the COVID-19 pandemic as well as the H1N1 pandemic. Since COVID-19 is a recent(even current) pandemic my process for data collection was differnt from his. Many of the sources that Tony used did not record data during COVID. I spent time working through many different sources; in the end, I found CDC's WonderAPI to be the most consisent and up-to-date source. 
